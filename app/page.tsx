  ...
  return (
    <main className="app-page space-y-5">
      <section className="rounded-3xl border border-emerald-500/30 bg-gradient-to-b from-emerald-500/10 to-slate-900 p-5">
        <p className="text-xs font-bold uppercase tracking-wider text-emerald-300">DeliveryCalc</p>
        <h1 className="mt-2 text-3xl font-black leading-tight text-white">כמה באמת נשאר לך נטו היום?</h1>
        <p className="mt-3 text-sm leading-relaxed text-slate-200">
          מעקב פשוט אחרי Wolt, HaAt ו-Ten Bis — מקטעים, דלק, ק״מ ורווח נטו לשעה.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-900 p-4">
        ...
        <p className="mt-2 text-sm text-slate-300">
          DeliveryCalc מחשב אוטומטית רווח נטו לפי פלטפורמה, זמן עבודה וק״מ — כולל השוואה בין Wolt, HaAt ו-Ten Bis.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-4">
        <h2 className="text-xl font-black text-white">התחל לעקוב אחרי היום</h2>
        <p className="mt-1 text-sm text-emerald-100">הוסף מקטע לכל פלטפורמה וראה מי הכי משתלם לך היום.</p>
        <div className="mt-3 grid grid-cols-1 gap-2">
          ...
          <Link
            ...
            className="flex min-h-[3rem] items-center justify-center rounded-2xl border border-sky-500/40 bg-slate-900 text-sm font-bold text-sky-100"
          >
            ניתוח פלטפורמות
          </Link>
          <Link
            href="/screenshot-analyzer"
            className="flex min-h-[3rem] items-center justify-center rounded-2xl border border-slate-700 bg-slate-900 text-sm font-bold text-slate-200"
          >
            צילומי מסך (Wolt)
          </Link>
        </div>
