...
const INCOME_KEYWORDS = [/haat|ha\s*at|האט|העט/i, /הכנסה/i, /סה.?כ/i, /רווח/i, /total/i, /earnings/i, /שכר/i];
const DELIVERY_KEYWORDS = [/משלוח/i, /הזמנ/i, /deliver/i, /orders/i, /tasks/i];

export function parseHaAtScreenshot(rawText: string): OcrExtractionDraft {
  ...
  const startTime = timeRange?.startTime ?? "11:00";
